...
var _Content = __webpack_require__(330);
...
var MyApp = function () {
    ...
    _createClass(MyApp, [{
        ...
        value: function showTab(id) {
            var targetedBtn = void 0;

            this.tabContents.forEach(function (tab) {
        ...
        key: "handleSwipAction",
        value: function handleSwipAction(evt, direction) {
            var tabContent = evt.target.closest('.tab-content');
            var tabID = tabContent.id;

            if (direction === 'right') {
                if (tabID === this.tabContents[0].id) this.showTab(this.tabContents[this.tabContents.length - 1].id);else this.showTab(tabContent.previousElementSibling.id);
            } else if (direction === 'left') {
                if (tabID === this.tabContents[this.tabContents.length - 1].id) this.showTab(this.tabContents[0].id);else this.showTab(tabContent.nextElementSibling.id);
            }
        }
    }, {
...
var AppHeader = function (_HTMLElement) {
...
var AppContent = function (_HTMLElement) {
    _inherits(AppContent, _HTMLElement);
